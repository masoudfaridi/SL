...
directions in which $X_1, . . . , X_p$ show the most variation are the directions
...
Let $Z_1, . . . , Z_M$ represent $M < p$ linear combinations of our original
...
a new set of features $Z_1, . . . , Z_M$ that are linear combinations of the original
